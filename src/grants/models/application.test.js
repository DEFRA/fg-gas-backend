...
describe("Application", () => {
  ...
  describe("getAcceptedAgreement", () => {
    ...
    it("should get accepted agreement when other agreements exist", () => {
      const ag1 = new Agreement({
        agreementRef: "agreement-123",
        latestStatus: AgreementStatus.Offered,
        history: [],
  ...
  it("terminates an agreement on an application", () => {
    const application = createTestApplication();
    ...
    application.terminateAgreement("agreement-1", "2021-06-03T15:00:00.000Z");
