...
export class Application {
  static fromPayload(code, schema, data) {
  ...
  static fromDocument(document) {
    return {
      ...
      identifiers: {
        sbi: document.identifiers.sbi,
        frn: document.identifiers.frn,
        crn: document.identifiers.crn,
        defraId: document.identifiers.defraId,
      },
