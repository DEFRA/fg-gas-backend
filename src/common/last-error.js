...
// document itself so an operator can see it without digging through the
...
// One entry of `attemptHistory` - the same three fields as `lastError`,
// built with the same truncation so a
