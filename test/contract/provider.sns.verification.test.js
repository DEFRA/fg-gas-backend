...
// 1) PASTE `agreement-created.json` -> contents here
const agreementCreatedMessage = {
  data: {
...
const agreementWithdrawnMessage = {
  data: {
    clientRef: "client-ref-002",
...
describe("fg-gas-backend-sns Provider Verification", () => {
  ...
  beforeAll(async () => {
    // Minimal HTTP server that serves the static contract messages
