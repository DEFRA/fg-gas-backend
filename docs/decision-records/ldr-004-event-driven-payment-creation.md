...
Payment cutover remains subject to the applicable gates below. Legacy Agreement scheme parity is not applicable to the current development-only cutover because no live Agreement scheme is being migrated. This scope does not approve live traffic or waive the Payment Service contract and deployment gates:
