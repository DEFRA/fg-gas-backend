 ...
 *
 * Changes vs. 20260427130000-woodland-rename-total-hectares:
 * - payments.agreement[].activePaymentTier:       exclusiveMinimum: 0 -> minimum: 0
 * - payments.agreement[].quantityInActiveTier:    exclusiveMinimum: 0 -> minimum: 0
 * - payments.agreement[].activeTierFlatRatePence: exclusiveMinimum: 0 -> minimum: 0
 * - payments.agreement[].quantity:                exclusiveMinimum: 0 -> minimum: 0
 * - payments.agreement[].agreementTotalPence:     exclusiveMinimum: 0 -> minimum: 0
 *
 * The earlier rename migration has already been applied in dev/ext, so this
 * one re-applies the full grant document to land the relaxed minimums.
 */
